...
class GroceryList extends React.Component {
  ...
  addGroceryItem(event) {
    if (!this.state.newGroceryName) {
      let newGroceries = this.state.groceries.concat(newGroceryName);
  ...
  render() {
    ...
    newProductInput = <input className='new-item' type="text" value={this.state.value} onChange={this.inputChanged}/>;
