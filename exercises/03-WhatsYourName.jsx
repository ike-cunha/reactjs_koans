...
this.state = { nomePessoa: "" };
  ...
  onNameChange(event) {
    // Huh... There's something wrong here...
     ...
     console.log("Evento: ", this.state.nomePessoa);
  }

  

  render() {
    var greeting = this.state.nomePessoa;
    ...
    return (
      <div>
        <p>{this.state.nomePessoa}</p>
        <input type="text" name="campoNome" value={this.state.value} onChange={this.onNameChange} />
      </div>
    );
  }
}
